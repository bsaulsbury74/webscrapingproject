...
print(f"DeathRate:{high_death_ratio}%")
print()
print()
...
print()
print()
print(f"The State with the worst test rate:{state_worst_test}")
print(f"The test rate{low_test_ratio}")
print()
print()
print(f"The State with the best test rate:{state_best_test}")
